...
const COMMITTEES = [
  {
    ...
    description: (
      <p>
        ...
        continuing legal education of CITBA members, and arranges for and
        conducts applicable meetings for lectures, discussions, and courses of
        study – subject to approval by CITBA’s Board. This Committee works
        closely with the Meetings and Special Events Committee regarding the
        logistics of events. The Committee also keeps itself and the CITBA Bar
        informed with respect to all matters concerning the professional
        responsibility of its members and to all matters relevant to
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        nominees and prospective nominees for Judgeships in the United States
        Court of International Trade and in the United States Court of Appeals
        for the Federal Circuit, and reports its findings to the Board of
        Directors for transmittal to the appropriate bodies. The Committee may
        invite and will consider all communications regarding such nominees.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        qualifications of candidates for membership in the various categories
        identified in CITBA’s by-laws, and reports its recommendations on
        membership applications to the Board of Directors. The Committee also
        promotes an understanding of CITBA to lawyers practicing in the customs
        or international trade area, identifies membership services of interest
        to the members, and otherwise assists in membership retention and
        development.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        the meetings to be held by CITBA and reports its selection to the Board.
        The Committee arranges the logistics of the event(s) sponsored by CITBA
        and prepares the notices of such event(s). The Committee also notifies
        CITBA’s membership of any special events of interest to members, upon
        direction by the President or the Board.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        professional organizations active in the trade and customs field, mainly
        with regard to events and programming, and occasionally with regard to
        policy issues of shared interest.
      </p>
    ),
  },
  {
    ...
    description: (
      <>
        <p>
          The Publications Committee is charged with the distribution,
          circulation, and marketing of CITBA brochures, circulars, and other
          publications, which CITBA may publish from time to time. This
          Committee also prepares and edits the quarterly CITBA Newsletter. The
          primary purpose of the newsletter is to review, discuss, and advise
          CITBA’s membership regarding recent customs and international trade
          issues. The newsletter and other circulars are also intended to
          provide topical information from the United States Court of
          International Trade and the United States Court of Appeals for the
          Federal Circuit as well as upcoming events of interest. To this end,
          the Publications Committee coordinates with other CITBA committees
          that may be involved with preparing, contributing, or disseminating
          information to members.
        </p>
        <p>
          The Committee is continually working to improve the newsletter’s
          quality. If you have any ideas or contributions that you would like to
          make to the quarterly CITBA newsletter, please do not hesitate to
          contact the Chair.
        </p>
      </>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        of the CITBA website, coordinating technology issues between and among
        other CITBA committees, and serving as the CITBA liaison on technology
        issues with the United States Court of International Trade.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        younger partners in law firms, junior and mid-level agency lawyers, and
        judicial clerks to meet and form relationships with their peers. The
        Committee sponsors and plans both substantive and social events, and is
    ...
    return (
      <>
        ...
        <Banner
          ...
          text="Committees"
          subtitle={[
            "Committee membership is open to all CITBA members.",
            "If you are interested in joining any of the Committees below, please contact the respective Chair(s).",
          ]}
        />
